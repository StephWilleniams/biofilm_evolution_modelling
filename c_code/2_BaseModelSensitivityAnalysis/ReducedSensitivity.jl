[println() for i in 1:3] # to make debugging easier

# This script defines the BFP model and solves the ODEs for the model using the true parameters
# Author: Steve

## Idea here is to run the sensitivity analysis on the model with the true parameters
## However, a subset of these are fixed: those expected to be well known.
## This gives a sense of the importance of these less-easily measured parameters.
...
savefig("f_figures/SM_redModel_N=$samples.png") 
display(plt)
