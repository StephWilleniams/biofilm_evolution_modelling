...
# FULL COMPLEXITY MODEL - ATTEMPT 1
...
out = zeros(40)
@sync @threads for run in 1:40


    modification_scaling = 0.1*run/40 # Percent change range for uniform scaling of true parameters
    ...
    # STORE OUTPUTS
    out[run] = -llhood(min_x,[])

end

plot(out .- maximum(out),ylims=(0,-5))
