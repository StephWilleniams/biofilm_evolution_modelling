...
# Removal of bind off rate

# PI factors
N_samples = 3 # Number of synthetic samples
...
N_varies = 51 # Univariate PI range bins
...
synthetic_data = zeros(3,N_times,N_samples)
...
function llhood1(params,_)
    ...
    predicted_sol = solve(prob, Vern6())
